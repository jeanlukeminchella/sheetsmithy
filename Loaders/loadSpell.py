...
spell = {
    ...
    "conc":False,
    "modiferIndex":-1,
    "preSaveNormalText":"Blind a creature within 30ft. CON",
    "postSaveNormalText":" to resist.",
    "preSaveItalicText":"You may repeat this with another Bonus Action during Rage.",
    "postSaveItalicText":"",
    "castTime":"a",
    "ritual":False
}
spellName = "Wild Magic 8.json"
